...
public final class DlgResepObat extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "21-03-2022 10:13:28" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "21-03-2022 10:13:29" }));
        ...
        DTPBeri.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "21-03-2022" }));
  ...
  isForm();                
        ...
        if(tabMode.getRowCount()==0){
            ...
            if(Sequel.cariInteger(
                ...
                Valid.MyReportqry("rptItemResep.jasper","report","::[ Aturan Pakai Obat ]::",
                    ...
                    "resep_obat.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,pasien.alamat,databarang.nama_brng,"+
    ...
    private void ppLembarObat1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppLembarObat1ActionPerformed
        if(tabMode.getRowCount()==0){
            ...
            Valid.MyReportqry("rptLembarObat2.jasper","report","::[ Lembar Pemberian Obat ]::","select temporary_resep.*, pasien.alamat, pasien.no_tlp from temporary_resep, pasien where pasien.no_rkm_medis='"+TNoRm.getText()+"' and temporary_resep.temp37='"+akses.getalamatip()+"' order by temporary_resep.no",param);
            this.setCursor(Cursor.getDefaultCursor());
        }
    ...
    private void ppLembarObat2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppLembarObat2ActionPerformed
        if(tabMode.getRowCount()==0){
            ...
            try {
                i=0;
                ps=koneksi.prepareStatement(
                    "select databarang.nama_brng,aturan_pakai.aturan,resep_dokter.jml,kodesatuan.satuan "+
                    "from resep_obat inner join reg_periksa inner join resep_dokter inner join "+
                    "aturan_pakai inner join databarang inner join detail_pemberian_obat "+
                    "inner join kodesatuan on resep_obat.no_rawat=reg_periksa.no_rawat "+
                    "and resep_obat.no_resep=resep_dokter.no_resep and "+
                    "databarang.kode_brng=aturan_pakai.kode_brng and resep_dokter.kode_brng=databarang.kode_brng "+
                    "and resep_obat.no_rawat=aturan_pakai.no_rawat and "+
                    "resep_obat.tgl_perawatan=aturan_pakai.tgl_perawatan and "+
                    "resep_obat.jam=aturan_pakai.jam and resep_obat.no_rawat=detail_pemberian_obat.no_rawat "+
                    "and resep_obat.tgl_perawatan=detail_pemberian_obat.tgl_perawatan and "+
                    "resep_obat.jam=detail_pemberian_obat.jam and kodesatuan.kode_sat=databarang.kode_sat "+
                    "where resep_obat.no_resep=? and aturan_pakai.aturan<>'' group by resep_dokter.kode_brng ");
                try {
                    ps.setString(1,NoResep.getText());
                    rs=ps.executeQuery();
                    while(rs.next()){
                ...
                psracikan=koneksi.prepareStatement(
                    "select resep_dokter_racikan.no_racik,resep_dokter_racikan.nama_racik,obat_racikan.tgl_perawatan,obat_racikan.jam, "+
                    "obat_racikan.no_rawat,resep_dokter_racikan.aturan_pakai,resep_dokter_racikan.jml_dr,metode_racik.nm_racik "+
                    "from resep_obat inner join reg_periksa inner join resep_dokter_racikan inner join "+
                    "obat_racikan inner join metode_racik on resep_obat.no_resep = resep_dokter_racikan.no_resep and "+
                    "resep_obat.no_rawat=reg_periksa.no_rawat "+
                    "and resep_dokter_racikan.kd_racik=metode_racik.kd_racik "+
                    "and resep_obat.no_rawat=obat_racikan.no_rawat and "+
                    "resep_obat.tgl_perawatan=obat_racikan.tgl_perawatan and "+
                    "resep_obat.jam=obat_racikan.jam and resep_obat.no_rawat=obat_racikan.no_rawat "+
                    "where resep_obat.no_resep=? group by no_racik ");
                try {
                    psracikan.setString(1,NoResep.getText());
                    rsracikan=psracikan.executeQuery();
                    while(rsracikan.next()){
                        rincianobat="";
                        ps2=koneksi.prepareStatement(
                            "select databarang.nama_brng,resep_dokter_racikan_detail.jml from "+
                            "detail_pemberian_obat  inner join databarang inner join detail_obat_racikan inner join resep_dokter_racikan_detail "+
                            "on resep_dokter_racikan_detail.kode_brng=databarang.kode_brng and "+
                            "resep_dokter_racikan_detail.kode_brng=detail_obat_racikan.kode_brng and "+ 
                            "detail_pemberian_obat.tgl_perawatan=detail_obat_racikan.tgl_perawatan and "+
                            "detail_pemberian_obat.jam=detail_obat_racikan.jam and "+
                            "detail_pemberian_obat.no_rawat=detail_obat_racikan.no_rawat "+
                            "where detail_pemberian_obat.tgl_perawatan=? and detail_pemberian_obat.jam=? and "+
                            "detail_pemberian_obat.no_rawat=? and detail_obat_racikan.no_racik=? "+
                            "group by resep_dokter_racikan_detail.kode_brng order by databarang.kode_brng ");
                        try {
                            ps2.setString(1,rsracikan.getString("tgl_perawatan"));
                            ps2.setString(2,rsracikan.getString("jam"));
                            ps2.setString(3,rsracikan.getString("no_rawat"));
            ...
            Valid.MyReportqry("rptLembarObat4.jasper","report","::[ Lembar Pemberian Obat ]::","select temporary_resep.*, pasien.alamat, pasien.no_tlp from temporary_resep, pasien where pasien.no_rkm_medis='"+TNoRm.getText()+"' and temporary_resep.temp37='"+akses.getalamatip()+"' order by temporary_resep.no",param);
            this.setCursor(Cursor.getDefaultCursor());
        }
